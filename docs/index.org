...
har ansvar for. *Status* for hver aktivitet kan være /{{{color(blue, Ferdig)}}}, {{{color(green, Pågående)}}}/ eller
/{{{color(red, Ikke begynt)}}}/, mens *Prioritering* kan være /A, B/ eller /C/ hvor /A/ er høyest
og /C/ er lavest.
