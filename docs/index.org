...
- Ta kontakt med Kommunikasjon avd. om hvordan dette skal tilrettelegges.
  Kontaktperson: [[http://minside.fhi.no/Person.aspx?accountname=FHI%5CERBU][Erik Bull-Valen]] eller [[http://minside.fhi.no/Person.aspx?accountname=FHI%5CKNBO][Knut Forr Børtnes]]
- Sendt henvendelse på e-post til Erik Bull-Valen/Knut Forr Børtnes 21.02.2023
