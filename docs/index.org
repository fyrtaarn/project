...
- Send endring for prosjektleder til REK. Ta kontakt med FAS om hvordan dette skal gjøre. Se [[https://folkehelse.sharepoint.com/sites/Forskningsstotte/SitePages/eProtokoll.aspx#hvordan-melde-inn-endringer-i-prosjektet][veiledning]] i SharePoint.
** Søk om tilgang til PDB
- Søk om tilgang til PDB 3327 for Christian Page. Ta kontakt med FAS [[mailto:FAS@fhi.no][FAS@fhi.no]]
- Data for Fyrtårnprosjektet ligger her.
** Overføring for søknaden hos Helsedata service
- Kari Alver tar over som kontakt person
- Det ikke er mulig å overføre søknader til ny søker/prosjektleder. Se [[https://folkehelse.sharepoint.com/:b:/s/2243/Ec18pSaPOG1CldHVEhPuacwB9kMq-MYkAk_cit3J_yklSg?e=pCPSaY][e-post]]
