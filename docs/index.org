...
har ansvar for. *Status* for hvert aktivitet kan være /{{{color(blue, Ferdig)}}}, {{{color(#07b504, Pågående)}}}/,
/{{{color(red, Ikke påbegynt)}}}/ eller /{{{color(#9b5c4c, Ikke aktuelt)}}}/, mens *Prioritering* kan være /A, B/ eller /C/ hvor /A/ er høyest
